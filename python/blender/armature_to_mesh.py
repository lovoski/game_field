...
def processArmature(context, arm, genVertexGroups = True, meshType = 'Pyramid'):
    ...
    try:
        ...
        for editBone in [b for b in arm.data.edit_bones if b.use_deform]:
            ...
            print(f'bone name {editBone.name}, num children {len(editBone.children)}')
            ...
            editBoneTail = editBone.children[0].head
            ...
            #editBoneSize = max(editBoneX, editBoneZ)
            #print(f'{editBone.name}, {editBoneX}, {editBoneZ}')
